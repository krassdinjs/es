...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 7228;
        $headers['auth']['clientCompany'] = "AZC8762Wx6j6Xk5Ilndd";
        $headers['auth']['clientSecret'] = "NzIyOEFaQzg3NjJXeDZqNlhrNUlsbmRkY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
